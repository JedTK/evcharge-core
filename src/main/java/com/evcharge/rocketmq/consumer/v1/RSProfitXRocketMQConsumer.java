 ...
 */
public class RSProfitXRocketMQConsumer {

    /**
     * 日志标签，用于标识日志信息来源
     */
    private final static String TAG = "分润RocketMQ消费者";
    ...
    public static void init() {
        ...
        for (Method method : RSProfitXRocketMQConsumer.class.getDeclaredMethods()) {
...
//                    , context.getMessageQueue().getTopic());
    ...
    private static SyncResult ChargeStation(JSONObject message) {
    ...
    private static SyncResult ChannelSummaryTask(JSONObject message) {
