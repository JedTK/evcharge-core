 ...
 */
public class GeneralDeviceXRocketMQConsumer {

    /**
     * 日志标签，用于标识日志信息来源
     */
    private final static String TAG = "通用设备RocketMQ消费者";
    ...
    public static void init() {
        ...
        for (Method method : GeneralDeviceXRocketMQConsumer.class.getDeclaredMethods()) {
