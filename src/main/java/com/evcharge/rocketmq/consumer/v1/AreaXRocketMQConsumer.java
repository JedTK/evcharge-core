 ...
 */
public class AreaXRocketMQConsumer {

    /**
     * 日志标签，用于标识日志信息来源
     */
    private final static String TAG = "地区RocketMQ消费者";
    ...
    public static void init() {
        ...
        for (Method method : AreaXRocketMQConsumer.class.getDeclaredMethods()) {
...
//                    , context.getMessageQueue().getTopic());
            ...
            for (MessageExt messageExt : list) {
                ...
                if (create_time != 0 && create_time + ECacheTime.HOUR <= TimeUtil.getTimestamp()) {
    ...
    private static SyncResult StreetDaySummaryTask(JSONObject message) {
    ...
    private static SyncResult StreetSummaryTask(JSONObject message) {
        String street = JsonUtil.getString(message, "street");
        String street_code = JsonUtil.getString(message, "street_code");
    ...
    private static SyncResult CommunitiesSummaryTask(JSONObject message) {
        String street = JsonUtil.getString(message, "street");
        String street_code = JsonUtil.getString(message, "street_code");
