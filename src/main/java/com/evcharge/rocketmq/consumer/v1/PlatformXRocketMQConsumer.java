 ...
 */
public class PlatformXRocketMQConsumer {

    /**
     * 日志标签，用于标识日志信息来源
     */
    private final static String TAG = "平台RocketMQ消费者";
    ...
    public static void init() {
        ...
        for (Method method : PlatformXRocketMQConsumer.class.getDeclaredMethods()) {
        ...
        // 关闭使用VIP通道
        X_ROCKET_MQ.getConsumerClient().setVipChannelEnabled(false);
        // 设置线程最大使用量
...
//        mExecutionThrottle.run(false, data -> {
        ...
        return new SyncResult(0, "");
//        }, String.format("%s:SummaryTaskV2", GROUP_NAME), ECacheTime.HOUR * 4, null);
//        return new SyncResult(0, "");
    }
}