 ...
 * 电动自行车充电订单结算
 */
public class SettlementForEBikeV3 implements IChargingSettlementV3 {
    private final static String TAG = "电动自行车充电结算v3";
    ...
    public SyncResult chargeFinish(ChargeOrderV3Entity orderEntity, DeviceEntity deviceEntity
        ...
        switch (billingType) {
            ...
            case Electricity:       //按电量结算
                return new SettlementForElectricityV3().chargeFinish(orderEntity, deviceEntity, stopTime, stopReasonCode, stopReasonText);
            default:
