 ...
 * @date : 2025-6-30
 */
public class DeviceYearSummaryEntity extends BaseEntity implements Serializable {
    //region -- 实体类属性 --
    /**
     * id
     */
     ...
     * 获得一个实例
     */
    public static DeviceYearSummaryEntity getInstance() {
        return new DeviceYearSummaryEntity();
    }
}
